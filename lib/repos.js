...
function findUrl(check, fallbackCheck, trust, pack, cb) {
  ...
  check(pack, function (err, url) {
    ...
    if (!url && fallbackCheck) return fallbackCheck(pack, cb);
...
var go = module.exports = function (opts, cb) {
  ...
  // fallbackCheck can be provided to provide another alternative to find url
  var fallbackCheck =  opts.fallbackCheck;
